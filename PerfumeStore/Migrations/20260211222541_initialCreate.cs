        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandAr = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "DescriptionAr", "DisplayOrder", "ImageUrl", "IsActive", "Name", "NameAr", "ParentCategoryId" },
                values: new object[,]
                {
                    { 1, "Premium men's fragrances", "عطور رجالية فاخرة", 1, null, true, "Men's Perfumes", "عطور رجالية", null },
                    { 2, "Elegant women's fragrances", "عطور نسائية راقية", 2, null, true, "Women's Perfumes", "عطور نسائية", null },
                    { 3, "Versatile unisex fragrances", "عطور متنوعة للجنسين", 3, null, true, "Unisex Perfumes", "عطور للجنسين", null },
                    { 4, "Exclusive luxury perfume collections", "مجموعات عطور فاخرة حصرية", 4, null, true, "Luxury Collections", "مجموعات فاخرة", null },
                    { 5, "Perfect gift sets for loved ones", "مجموعات هدايا مثالية لأحبائك", 5, null, true, "Gift Sets", "هدايا", null }
                });
